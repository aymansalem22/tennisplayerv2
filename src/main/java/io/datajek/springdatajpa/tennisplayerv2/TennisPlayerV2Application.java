...
public class TennisPlayerV2Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		logger.info("\n\n>> Update Player: {}\n",
				repo.updatePlayer(new Player(2, "Monfils", "France", Date.valueOf("1986-09-01"), 20)));

		logger.info("\n\n>> Player with id 2: {}\n", repo.getPlayerById(2));

		logger.info("\n\n>> Inserting Player: {}\n",
				repo.insertPlayer(new Player("Alex", "Spain", Date.valueOf("1985-09-01"), 50)));

		repo.deleteById(3);

		logger.info("Inserting Player: {}",
				repo.insertPlayer(new Player("Thiem", "Austria", Date.valueOf("1993-09-03"), 17)));
